...
--
-- Host: localhost
-- Generation Time: Nov 05, 2021 at 06:35 AM
...
--
-- Database: `chronic_kidney_disease`
--
CREATE DATABASE IF NOT EXISTS `chronic_kidney_disease` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `chronic_kidney_disease`;
...
('h2q9j38cggts9skdckxe2r8mwnqehk6i', 'eyJ1c2VyaWQiOjExfQ:1mhnAv:-aBUbzlPDtaczpoU_t0h65cAYj-KrHD0n22lpKHHB8g', '2021-11-16 06:21:37.678199'),
...
('u5jo7lj1lq2layu37v5pzr4rokercr9m', 'eyJ1c2VyaWQiOjI1fQ:1mhp9u:Pok7lKzmVYdOOya95wa4UlPXEr6pGuuqweF6r9GDljE', '2021-11-16 08:28:42.293681'),
...
--
-- Table structure for table `remote_user_kidney_disease_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_kidney_disease_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id1` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `bp` varchar(300) NOT NULL,
  `sg` varchar(300) NOT NULL,
  `al` varchar(300) NOT NULL,
  `su` varchar(300) NOT NULL,
  `rbc` varchar(300) NOT NULL,
  `pc` varchar(300) NOT NULL,
  `pcc` varchar(300) NOT NULL,
  `ba` varchar(300) NOT NULL,
  `bgr` varchar(300) NOT NULL,
  `bu` varchar(300) NOT NULL,
  `sc` varchar(300) NOT NULL,
  `sod` varchar(300) NOT NULL,
  `pot` varchar(300) NOT NULL,
  `hemo` varchar(300) NOT NULL,
  `pcv` varchar(300) NOT NULL,
  `wc` varchar(300) NOT NULL,
  `rc` varchar(300) NOT NULL,
  `htn` varchar(300) NOT NULL,
  `dm` varchar(300) NOT NULL,
  `cad` varchar(300) NOT NULL,
  `appet` varchar(300) NOT NULL,
  `pe` varchar(300) NOT NULL,
  `ane` varchar(300) NOT NULL,
...
--
-- Table structure for table `remote_user_kidney_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_kidney_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id1` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `bp` varchar(300) NOT NULL,
